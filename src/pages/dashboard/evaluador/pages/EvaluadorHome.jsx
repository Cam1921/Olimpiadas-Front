...
export default function EvaluadorHome({ idAreaNivelFase, nombreNivel, estadoNivel }) {
    ...
    <div className="p-6">
      <header className="mb-4">
        <h1 className="text-2xl md:text-3xl font-semibold text-gray-800">
          Calificación de competidores {nombreNivel ? `del Nivel ${nombreNivel}` : ""}
        </h1>
        <p className="text-gray-500">Registra calificaciones y observaciones.</p>
      </header>
