          ...
          <div className="p-4 space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <div className="text-sm">
                  {format(new Date(log.fecha + "T00:00:00"), "dd/MM/yyyy", {
                    locale: es,
                  })}{" "}
                  — {log.hora}
                </div>
              ...
              <div>
                ...
                <div>
                  <span
                    className={`px-2 py-0.5 text-xs rounded border ${tipoAccionClasses(
                      log.tipoAccion
                    )}`}
                  >
                    {log.tipoAccion}
            ...
            <div className="bg-amber-50 border border-amber-200 p-3 rounded">
              <p className="text-xs text-amber-900">
                <strong>Importante:</strong> Este registro es permanente y no
                puede ser editado ni eliminado. Forma parte del sistema de
                trazabilidad para auditorías y reclamos oficiales.
              </p>
            </div>
