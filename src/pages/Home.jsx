  ...
  return (
    <div className="min-h-screen bg-[#f9fbfb]">
      ...
      <main className="mx-auto max-w-6xl px-4 py-12">
        {/* HERO */}
        <section aria-label="Hero" className="grid items-center  md:grid-cols-1">
          {/* Texto */}
            <div className="space-y-5 grid grid-cols-2 gap-10">
                <div className="grid gap-4">
                    ...
                    potencial académico y compite con los mejores estudiantes del país.
                    </p>
                </div>
                {/* Placeholder derecha */}
        ...
        <section className="mt-20">
          ...
          <p className="mx-auto max-w-4xl text-center text-ink/70 leading-relaxed">
            El Comité de la Olimpiadas Científica Nacional San Simón O! SANSi, a través de la Facultad
            de Ciencias y Tecnología de la Universidad Mayor de San Simón, convoca a los estudiantes
            del Sistema de Educación Regular a participar en las Olimpiadas O! SANSi 2025.
          </p>
          ...
          <p className="mx-auto max-w-4xl text-center text-ink/70 leading-relaxed mb-8">
            Estudiantes del Subsistema de Educación Regular del Estado Plurinacional de Bolivia; en las áreas de:
            MATEMÁTICA, FÍSICA, QUÍMICA, BIOLOGÍA, ASTRONOMÍA Y ASTROFÍSICA, e INFORMÁTICA; de acuerdo al siguiente detalle:
          </p>
          ...
          <div className="bg-white rounded-2xl shadow-soft overflow-hidden border border-slate-200">
            ...
            <ul className="divide-y divide-slate-200">
              {[
                ["Astronomía y Astrofísica", "De tercero de primaria a 6to de secundaria"],
                ...
                <li key={area} className="grid grid-cols-1 md:grid-cols-2 px-4 py-4">
        ...
        <section className="mt-20">
          <h2 className="text-center text-ink mb-8 tracking-wide">INFORMACIÓN</h2>

          <div className="grid gap-6 md:grid-cols-2">
            {/* Card 1 */}
            <article className="bg-white rounded-2xl shadow-soft border border-slate-200 p-6">
              <h3 className="text-[var(--primary)] font-semibold mb-4">Contacto General</h3>
              <dl className="space-y-3 text-ink">
                <div>
                  <dt className="font-semibold text-lg">Email:</dt>
                  <dd className="text-ink/80">
                    <a href="mailto:olimpiadas@fcyt.umss.edu.bo" className="underline-offset-2 hover:underline">
            ...
            {/* Card 2 */}
            <article className="bg-white rounded-2xl shadow-soft border border-slate-200 p-6">
              <h3 className="text-[var(--primary)] font-semibold mb-4">Soporte Técnico</h3>
              <dl className="space-y-3 text-ink">
                <div>
                  <dt className="font-semibold text-lg">Plataforma Digital:</dt>
                  <dd className="text-ink/80">
                    <a href="mailto:soporte.olimpiadas@umss.edu.bo" className="underline-offset-2 hover:underline">
                      soporte.olimpiadas@umss.edu.bo
                    </a>
                  </dd>
                </div>
                <div>
                  <dt className="font-semibold text-lg">Horario de Atención:</dt>
                  <dd className="text-ink/80">
          ...
          <p className="mx-auto max-w-3xl text-center text-ink/60 mt-10">
            Para consultas específicas sobre cada área de competencia, favor contactar
            directamente con los responsables de área a través de la plataforma oficial
            o los canales de comunicación proporcionados.
          </p>
        </section>
      </main>
