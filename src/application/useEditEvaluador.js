// src/application/useRegisterEvaluador.js
...
export function useRegisterEvaluador(takenAreas = []) {
  ...
  useEffect(() => {
    ...
    // ✅ Validación flexible del nivel: debe pertenecer a los niveles de la área
    if (form.area && form.nivel) {
  ...
  const validate = useCallback((data, takenAreas) => {
    ...
    // ✅ Validación del nivel contra los niveles reales del área
