    ...
    >
      ...
      >
        ...
        <div className="flex items-start justify-between">
          <h2
            id="login-title"
            className="text-ink text-3xl md:text-[var(--fs-h2)] font-bold flex items-center gap-3"
          >
        ...
        <form className="space-y-4" onSubmit={onSubmit} noValidate>
          {/* Email */}
          <div>
            <label htmlFor="email" className="block text-ink mb-1">
              Correo electrónico
            </label>
            <input
              id="email"
            ...
            {emailLimitMsg && (
              <p id="email-limit" className="text-[var(--danger)] text-sm mt-1">
                {emailLimitMsg}
              </p>
            )}
            {emailInvalid && (
              <p id="email-help" className="text-[var(--danger)] text-sm mt-1">
                {emailError}
              </p>
            )}
          </div>
          ...
          {/* Password */}
          <div>
            <label htmlFor="password" className="block text-ink mb-1">
              Contraseña
            </label>
          ...
          <div className="text-center">
            <a
              href="#"
              className="text-ink/60 hover:text-ink underline-offset-2"
            >
              ¿Olvidaste tu contraseña?
            </a>
          </div>
